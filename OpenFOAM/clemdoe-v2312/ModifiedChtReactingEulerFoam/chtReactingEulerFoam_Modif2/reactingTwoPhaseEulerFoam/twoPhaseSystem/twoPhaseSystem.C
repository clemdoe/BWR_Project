...
void Foam::twoPhaseSystem::solve()
{
    ...
    // Se define el termino fuente de la tasa de dilatacion.
    // Consiste en el termino fuente de la ecuacion de alpha debido a la
    // compresibilidad, pero en el caso del reacting tambien se completa con
    // el dm/dt del "YEqns.H"

    //tdgdt tasa de dilatacion 
    ...
    for (int acorr=0; acorr<nAlphaCorr; acorr++)
    {
        ...
        // Ensure the phase-fractions are bounded
                ...
                // Ojo con esta magia que la hicimos para que corra, xq terminaba reventando despues cuando calculaba
                // la parte turbulenta porque me da valores de alpha 0 o 1.
                // Esto es similar a poner un residual alpha
                 alpha1 = Foam::min(Foam::max(alpha1,1e-9),0.999999999);  //*God
