...
#include "linearTsubDiameter_Modif.H"
...
{
    defineTypeNameAndDebug(linearTsubModif, 0);
...
Foam::diameterModels::linearTsubModif::linearTsubModif
(
...
Foam::tmp<Foam::volScalarField> Foam::diameterModels::linearTsubModif::d() const
{
    return d_;
}


void Foam::diameterModels::linearTsubModif::correct()
{
...
bool Foam::diameterModels::linearTsubModif::read(const dictionary& phaseProperties)
{
