...
print(f'epsilon_old: {epsilon_old}, rho_g_old: {rho_g_old}, rho_l_old: {rho_l_old}, rho_old: {rho_old}, V_gj_old: {V_gj_old}, Vgj_prime: {Vgj_prime}, areaMatrix: {areaMatrix}, Dhfg: {Dhfg}, C0: {C0}, x_th: {x_th}, T: {T}')
